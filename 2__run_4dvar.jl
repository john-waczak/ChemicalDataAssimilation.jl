...
if try_solve
    b = @benchmark loss(u0a)
    println("----")
    println("median time for loss function evaluation: ", median(b))
    println("mean time for loss function evaluation: ", mean(b))
    println("----")
end
...
if try_solve
    ...
    println("----")
    println("median time for loss gradient evaluation: ", median(b))
    println("mean time for loss gradient evaluation: ", mean(b))
    println("----")
