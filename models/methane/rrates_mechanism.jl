...
df_mech_rate_coeffs.k_51 = @. 3.8e-13*exp(780/df_params.temperature)*(1-1/(1+498*exp(-1160/df_params.temperature)))*my_ones
df_mech_rate_coeffs.k_52 = @. 3.8e-13*exp(780/df_params.temperature)*(1/(1+498*exp(-1160/df_params.temperature)))*my_ones
df_mech_rate_coeffs.k_53 = @. 2.3e-12*exp(360/df_params.temperature)*0.001*my_ones
df_mech_rate_coeffs.k_54 = @. 2.3e-12*exp(360/df_params.temperature)*0.999*my_ones
df_mech_rate_coeffs.k_55 = @. df_rrate_coeffs.KMT13*my_ones
df_mech_rate_coeffs.k_56 = @. 1.2e-12*my_ones
df_mech_rate_coeffs.k_57 = @. 2*df_rrate_coeffs.KCH3O2*RO2ᵢ*7.18*exp(-885/df_params.temperature)*my_ones
df_mech_rate_coeffs.k_58 = @. 2*df_rrate_coeffs.KCH3O2*RO2ᵢ*0.5*(1-7.18*exp(-885/df_params.temperature))*my_ones
df_mech_rate_coeffs.k_59 = @. 2*df_rrate_coeffs.KCH3O2*RO2ᵢ*0.5*(1-7.18*exp(-885/df_params.temperature))*my_ones
df_mech_rate_coeffs.k_60 = @. df_photolysis.J_41*my_ones
df_mech_rate_coeffs.k_61 = @. 5.3e-12*exp(190/df_params.temperature)*0.6*my_ones
df_mech_rate_coeffs.k_62 = @. 5.3e-12*exp(190/df_params.temperature)*0.4*my_ones
df_mech_rate_coeffs.k_63 = @. df_photolysis.J_11*my_ones
df_mech_rate_coeffs.k_64 = @. df_photolysis.J_12*my_ones
df_mech_rate_coeffs.k_65 = @. 5.5e-16*my_ones
df_mech_rate_coeffs.k_66 = @. 5.4e-12*exp(135/df_params.temperature)*my_ones
df_mech_rate_coeffs.k_67 = @. df_photolysis.J_51*my_ones
df_mech_rate_coeffs.k_68 = @. 4.0e-13*exp(-845/df_params.temperature)*my_ones
df_mech_rate_coeffs.k_69 = @. 7.2e-14*exp(-1080/df_params.temperature)*df_params.O2*my_ones
df_mech_rate_coeffs.k_70 = @. df_rrate_coeffs.KMT14*my_ones
df_mech_rate_coeffs.k_71 = @. 2.85e-12*exp(-345/df_params.temperature)*my_ones
